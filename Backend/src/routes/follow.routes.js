...
const { sendFollowRequest, acceptFollowRequest, rejectFollowRequest, unfollowUser, getFollowers, getFollowings, getPendingRequests } = require("../controllers/follow.controller");
const { verifyJWT } = require("../middlewares/auth.middleware");

const router = express.Router();

router.post("/request/:targetUserId", verifyJWT, sendFollowRequest);
router.post("/unfollow/:targetUserId", verifyJWT, unfollowUser);
